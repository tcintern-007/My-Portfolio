...
import { FaEnvelope, FaPhoneAlt, FaGithub, FaLinkedinIn, FaPaperPlane, FaCheckCircle } from 'react-icons/fa';
    ...
    <section id="contact" className="py-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12">
              ...
              return (
                ...
                >
                  ...
                  <a
                    ...
                    className="text-theme-secondary hover:text-[#6c63ff] dark:hover:text-[#6c63ff] light:hover:text-[#6c63ff] blue:hover:text-[#3b82f6] transition-colors break-all"
                  >
                    {item.label}
                  </a>
                </div>
          ...
          <div>
            {submitted ? (
              <div className="bg-theme-card p-8 rounded-2xl border border-theme flex flex-col items-center justify-center text-center h-full">
                <FaCheckCircle className="text-5xl text-green-500 mb-4" />
                <h3 className="text-2xl font-bold text-theme-primary mb-2">Thank You!</h3>
                <p className="text-theme-secondary">Your message has been sent successfully. I'll get back to you soon.</p>
              </div>
            ) : (
              <form
              ...
              >
                <div className="mb-5">
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg border-2 border-[rgba(108,99,255,0.2)] dark:border-[rgba(108,99,255,0.2)] light:border-[rgba(108,99,255,0.12)] blue:border-[rgba(59,130,246,0.2)] bg-theme-primary text-theme-primary transition-all duration-300 focus:outline-none focus:border-[#6c63ff] dark:focus:border-[#6c63ff] light:focus:border-[#6c63ff] blue:focus:border-[#3b82f6] focus:shadow-[0_0_0_4px_rgba(108,99,255,0.15)]"
                  />
                </div>
                <div className="mb-5">
                ...
                <div className="mb-6">
                  ...
                  <textarea
                    ...
                    required
                    rows="5"
                    className="w-full px-4 py-3 rounded-lg border-2 border-[rgba(108,99,255,0.2)] dark:border-[rgba(108,99,255,0.2)] light:border-[rgba(108,99,255,0.12)] blue:border-[rgba(59,130,246,0.2)] bg-theme-primary text-theme-primary transition-all duration-300 focus:outline-none focus:border-[#6c63ff] dark:focus:border-[#6c63ff] light:focus:border-[#6c63ff] blue:focus:border-[#3b82f6] focus:shadow-[0_0_0_4px_rgba(108,99,255,0.15)] resize-y min-h-[140px]"
                  />
                </div>
                <button
                  type="submit"
